class Characterisation(object):
    def __init__(char_self):
        ...
        char_self.techniques = {"Morphology": ["SEM", "SEM+EDX", "TEM", "TEM+EDX", "TEM diffraction", "Optical","XCT", "FIB+SEM"],
                      ...
                      "Electrode properties": ["4-point conductivity", "Other conductivity", "TGA", "DSC", "ICP-OES", "TOF SIMS"],
        ...
        char_self.vbox = wg.VBox([wg.Label(value="For Li-S: raw material = host matrix, composite = carbon/ sulfur composite"),
                                  wg.Label(value="For NMC: raw material = NMC powder, ignore composite"),         
            wg.HBox([char_self.save_button, char_self.save_label]),
                                  char_self.accordion])
